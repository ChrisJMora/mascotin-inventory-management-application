...
In inventorymanagementapplication-labels_en.properties:
inventorymanagementapplication=My application
inventorymanagementapplication[description]=My application does this and that

In inventorymanagementapplication-messages_en.properties:
